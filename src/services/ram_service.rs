    ...
    impl SystemMonitor for MockMonitor {
        fn snapshot(&mut self) -> anyhow::Result<SystemSnapshot> {
            ...
            Ok(SystemSnapshot {
                ...
                top_processes: vec![
                    ProcessMemInfo { pid: 111, name: "big.exe".into(), memory_bytes: 500, read_bytes: 0, write_bytes: 0, total_written_bytes: 0, start_unix: 1_700_000_000 },
                    ProcessMemInfo { pid: 222, name: "mid.exe".into(), memory_bytes: 300, read_bytes: 0, write_bytes: 0, total_written_bytes: 0, start_unix: 1_700_000_000 },
                    ProcessMemInfo { pid: 333, name: "small.exe".into(), memory_bytes: 100, read_bytes: 0, write_bytes: 0, total_written_bytes: 0, start_unix: 1_700_000_000 },
                ],
            })
        }
    }
